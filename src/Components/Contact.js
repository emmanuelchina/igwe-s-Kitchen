    ...
    <div className=" bg-orange-50 px-6 py-24 sm:py-32 lg:px-8 text-white">
      ...
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md bg-gray-300 px-3.5 py-2.5 text-center text-sm font-semibold text-gray-900 shadow-xs hover:bg-orange-900 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
          Submit
          </button>
            <div className="text-center mt-10 space-y-2 text-gray-800">
  <p>📍 24 Awolowo Street, Lagos, Nigeria</p>
  <p>📞 +234 915 126 5480</p>
  <p>✉ info@igweemmanuelchina@gmail.com</p>
