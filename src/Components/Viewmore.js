...
const products = [
  ...
  },
  {
    ...
    price: "7000",
    imageSrc: "/img/nsala-soup.jpeg", 
    imageAlt: "Nsala Soup (white soup)",
    href: "#nsala",
  },
  {
    id: 17,
  ...
  return (
    <div className="bg-orange-50 text-gray-800 pt-10 min-h-screen">
      ...
      >
        ...
        transition={{ duration: 0.7, ease: "easeOut" }}
      >
       Excellence is prepared here daily with discipline, precision, and respect for every ingredient.
      </motion.p>
